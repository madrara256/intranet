...
class QualifiedCompanies(models.Model):
    ...
    default_cat = 'goods_and_services'
    ...
    directors = models.CharField(max_length=256, blank=True, null=True)
    goods_and_services = models.TextField(blank=True, null=True)
    category = models.CharField(max_length=100, choices=category, default=default_cat)
...
class ImageTag(models.Model):
    ...
    tag_name = models.CharField(max_length=256, default='Misc')
...
class ImageGallery(models.Model):
    ...
    image_description = models.CharField(max_length=256, default='Finance Trust Bank Image')
    image_tag = models.ForeignKey(ImageTag, null=True, blank=True)
    image = models.FileField(upload_to='image_gallery', blank=True)
